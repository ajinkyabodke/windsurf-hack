...
${JSON.stringify(activities)}`;
  ...
  return (
    <div className="fixed right-10 bottom-10 space-y-6 rounded-full border-2 border-black bg-gradient-to-br from-amber-100 via-amber-50 to-amber-200/50 p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
      <motion.div
